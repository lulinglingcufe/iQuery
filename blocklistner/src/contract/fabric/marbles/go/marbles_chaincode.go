...
func (t *SimpleChaincode) initMarble(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	fmt.Println("PutState elapsed: ", elapsed)
	...
	fmt.Println("CreateCompositeKey elapsed: ", elapsed2)
...
func (t *SimpleChaincode) readMarble(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	elapsed := time.Since(t1)
	fmt.Println("GetState elapsed: ", elapsed)
...
func (t *SimpleChaincode) delete(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	elapsed := time.Since(t1)
	fmt.Println("DelState elapsed: ", elapsed)
	...
	fmt.Println("CreateCompositeKey indexName color~name elapsed: ", elapsed3)
	...
	elapsed2 := time.Since(t2)
	fmt.Println("DelState colorNameIndexKey elapsed: ", elapsed2)
...
func (t *SimpleChaincode) getMarblesByRange(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	elapsed := time.Since(t1)
	fmt.Println("GetStateByRange elapsed: ", elapsed)
...
func (t *SimpleChaincode) transferMarblesBasedOnColor(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	elapsed := time.Since(t1)
	fmt.Println("GetStateByPartialCompositeKey use color~name index elapsed: ", elapsed)
	...
	for i = 0; coloredMarbleResultsIterator.HasNext(); i++ {
		...
		elapsed2 := time.Since(t2)
		fmt.Println("SplitCompositeKey get compositeKeyParts elapsed: ", elapsed2)
...
func (t *SimpleChaincode) queryMarblesByOwner(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	queryString := fmt.Sprintf("{\"selector\":{\"docType\":\"marble\",\"owner\":\"%s\"}, \"use_index\":[\"_design/indexOwnerDoc\", \"indexOwner\"]}", owner)
	//	queryString := fmt.Sprintf("{\"selector\":{\"docType\":\"marble\",\"owner\":\"%s\"}}", owner)

	t1 := time.Now()
	queryResults, err := getQueryResultForQueryString(stub, queryString)
	elapsed := time.Since(t1)
	fmt.Println("getQueryResultForQueryString elapsed: ", elapsed)
...
func getQueryResultForQueryString(stub shim.ChaincodeStubInterface, queryString string) ([]byte, error) {
	...
	elapsed2 := time.Since(t2)
	fmt.Println("getQueryResultForQueryString elapsed: ", elapsed2)
...
func (t *SimpleChaincode) getHistoryForMarble(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	elapsed := time.Since(t1)
	fmt.Println("GetHistoryForKey elapsed: ", elapsed)

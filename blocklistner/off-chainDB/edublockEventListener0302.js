...
const blockProcessing = require('./blockProcessingnewtime.js');

const ccpPath = path.resolve(__dirname, 'edu', 'connection-org1-edu.json');
...
async function main() {
    try {
        ...
        await gateway.connect(ccpPath, { wallet, identity: 'admin.Org1', discovery: { enabled: true, asLocalhost: true } });
